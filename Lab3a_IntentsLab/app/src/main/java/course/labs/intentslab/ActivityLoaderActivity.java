...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		Intent GetText = new Intent(this, ExplicitlyLoadedActivity.class);
		
		// TODO - Стартуйте Activity используя этот интент и код запроса, описанный выше
		startActivityForResult(GetText, GET_TEXT_REQUEST_CODE);
	...
	private void startImplicitActivation() {
		...
		Intent choo = Intent.createChooser(baseintent, CHOOSER_TEXT);
